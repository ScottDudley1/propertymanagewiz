  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      ...
      >
        ...
        <span className="flex-1 font-medium text-gray-900">{niche.name}</span>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Niche Discovery Tracker</h1>
      ...
      {niches.length > 0 && (
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            ...
            <p className="text-3xl font-bold text-gray-900">{niches.length}</p>
