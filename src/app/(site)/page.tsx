    ...
    <div>
      ...
      <section className="bg-white pt-20 pb-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-violet-50 text-violet-600 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 uppercase tracking-wide">
            Free Decision Tool
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight mb-6">
            Find the right property management software.<br />
            <span className="text-violet-500">In 2 minutes.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/wizard"
              className="bg-violet-500 text-white font-semibold px-8 py-4 rounded-xl hover:bg-violet-600 transition-colors text-lg"
            >
              Find My Software →
            </Link>
            <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="bg-white rounded-2xl p-8 border border-gray-100">
                <div className="w-10 h-10 bg-violet-500 text-white rounded-xl flex items-center justify-center font-bold text-lg mb-4">
                  {item.step}
                </div>
      ...
      {/* CTA */}
      <section className="bg-violet-500 py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to find your software?</h2>
          <p className="text-violet-200 mb-8">Takes 2 minutes. No email required.</p>
          <Link
            href="/wizard"
            className="bg-white text-violet-500 font-semibold px-8 py-4 rounded-xl hover:bg-violet-50 transition-colors text-lg inline-block"
          >
